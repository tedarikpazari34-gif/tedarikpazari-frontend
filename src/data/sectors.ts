...
export const sectors: Sector[] = [
  ...
  {
    id: "dental-dis-hekimligi",
    name: "Dental ve Diş Hekimliği",
    slug: "dental-ve-dis-hekimligi",
    shortDescription: "Diş hekimliği sarfları, el aletleri, klinik ve öğrenci malzemeleri",
    iconLetter: "D",
  },
  {
    id: "tekstil-konfeksiyon",
    name: "Tekstil ve Konfeksiyon",
    slug: "tekstil-ve-konfeksiyon",
    shortDescription: "Kumaş, iplik, aksesuar, dikim ve konfeksiyon ürünleri",
    iconLetter: "T",
  },
  {
    id: "egitim-okul-malzemeleri",
    name: "Eğitim ve Okul Malzemeleri",
    slug: "egitim-ve-okul-malzemeleri",
    shortDescription: "Okul, kurs, üniversite ve eğitim kurumları için malzemeler",
    iconLetter: "E",
  },
  {
    id: "kozmetik-kuafor",
    name: "Kozmetik ve Kuaför",
    slug: "kozmetik-ve-kuafor",
    shortDescription: "Profesyonel salon, bakım, kozmetik ve sarf ürünleri",
    iconLetter: "K",
  },
  {
    id: "laboratuvar",
    name: "Laboratuvar",
    slug: "laboratuvar",
    shortDescription: "Laboratuvar sarfları, cihazları ve teknik ekipmanları",
    iconLetter: "L",
  },
  {
    id: "veteriner-pet",
    name: "Veteriner ve Pet Ürünleri",
    slug: "veteriner-ve-pet-urunleri",
    shortDescription: "Veteriner klinikleri ve pet işletmeleri için ürün ve ekipmanlar",
    iconLetter: "V",
  },
  {
    id: "fason-uretim",
    name: "Fason Üretim ve Özel Üretim",
    slug: "fason-uretim-ve-ozel-uretim",
    shortDescription: "Markaya özel üretim, fason imalat ve üretim hizmetleri",
    iconLetter: "F",
  },
