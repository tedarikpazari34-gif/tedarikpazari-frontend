    ...
    <div style={pageStyle}>
      <div style={sectionCardStyle}>
        ...
        <div style={{ marginTop: 10 }}>
          <b>Rol:</b> {role || "-"} | <b>Token:</b> {token ? "var" : "yok"}
        </div>
        ...
        <div style={{ marginTop: 10 }}>
          {role === "BUYER" && (
            <>
              ...
              <button onClick={loadDisputes} style={secondaryButtonStyle}>
                Dispute yükle
              </button>
            </>
          )}
          ...
          {role === "SELLER" && (
            <>
              ...
              <button onClick={loadOrders} style={secondaryButtonStyle}>
                Order yükle
              </button>
            </>
          )}
          ...
          {role === "ADMIN" && (
            <>
              ...
              <button
                onClick={loadAdminMetricsOverview}
                style={{ ...secondaryButtonStyle, marginRight: 8 }}
              >
                Metrics Overview
              </button>
              ...
              <button
                onClick={loadAdminMetricsTimeseries}
                style={{ ...secondaryButtonStyle, marginRight: 8 }}
              >
                Metrics Timeseries
              </button>
      ...
      >
        <div>
          <h1 style={{ fontSize: 32, marginBottom: 10 }}>
            Talep Bazlı B2B Toptan Ticaret Platformu
          </h1>

          <p style={{ opacity: 0.85, maxWidth: 560 }}>
            Alıcılar ürün talebi oluşturur, tedarikçiler teklif verir. Güvenli
            ödeme sistemi ile ticaret tamamlanır.
          </p>
        ...
        <img
          src="https://images.unsplash.com/photo-1581091012184-7c46c40f4c60"
          alt="B2B marketplace"
          style={{
            width: 260,
            borderRadius: 12,
